...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Distro | Distro Online telengkap dan terpercaya di cikarang</title> 
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="#"><img src="img/logo1.png" alt="Logo"></a>
...
<!---->
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Dapatkan kemudahan berbelanja di Distro Cikarang, Kami menyediakan kebutuhan untuk fasion anda.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Anda bisa memesan produk kami melalui gadget kesayangan anda, belanja di Distro cikarang praktis dan mudah.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
				...
				<div class="span9">
					...
					<div id="footer-menu-links">
						...
						<ul id="footer-nav">
							...
							<li><a href="produk.php">Kemeja</a></li>

							<li><a href="produk.php">Kaos</a></li>

							<li><a href="produk.php">Sweater</a></li>

							<li><a href="produk.php">Jacket</a></li>
							
							<li><a href="produk.php">Pants & Jeans</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<h3>Tentang Distro</h3>
					<p>
						Distro adalah toko online yang bergerak di bidang fasion, sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
				...
				<div class="span3">
					...
					<h3>Alamat Kami</h3>
					Kp. Walrus belok kanan belok kiri<br />
                    Telp : 0819421-<br />
                    Email : <a href="mailto:triplex@facebook">triplex@facebook</a> / <a href="triplex@facebook">triplex@facebook</a>
				</div>
				<!-- end: Photo Stream -->
	...
	<div id="copyright">
		...
		<div class="container">
			...
			<p>
				Copyright &copy; <a href="http://www.niqoweb.com">Distro</a> <a href="http://bootstrapmaster.com" alt="Bootstrap Themes">Bootstrap Themes</a> designed by Bootstrap
			</p>
